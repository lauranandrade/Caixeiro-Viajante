...
int main(int argc, char const *argv[])
{
	...
	ordemAux = malloc(n * sizeof(int)); //Array para guardar a ordem de cidades visitadas que vai comparar com a atual menor ordem
	coordenadas = criaMatriz(2, n+1); //Matriz para guardar as coordenadas das cidades
	DC = criaMatrizDouble(n+1, n+1); //Matriz para guardar todas as distâncias entre todas as cidades
